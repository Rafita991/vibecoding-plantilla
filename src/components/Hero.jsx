...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="relative overflow-hidden pt-32 pb-24 px-6 bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="relative max-w-5xl mx-auto text-center">
        <span className="inline-block px-4 py-1.5 mb-6 text-sm font-medium text-green-200 bg-green-400/10 rounded-full border border-green-400/40 neon-glow">
          {badge}
        </span>
        <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-white leading-tight mb-6">
          {title}
          <span className="text-green-300 neon-text"> {titleHighlight}</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            ...
            className="hover-float w-full sm:w-auto px-8 py-3.5 border border-slate-600 text-slate-100 font-medium rounded-full hover:border-green-300 hover:text-green-200 hover:bg-slate-800 transition-all text-center"
          >
            {ctaSecondary}
          </a>
        </div>
        <div className="mt-14 mx-auto w-full max-w-xl rounded-3xl border border-green-400/30 bg-slate-900/70 p-6 neon-glow hover-float">
          <div className="relative mx-auto flex h-56 w-full items-center justify-center overflow-hidden rounded-2xl border border-slate-700 bg-slate-950">
